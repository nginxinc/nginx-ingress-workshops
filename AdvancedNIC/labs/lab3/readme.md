# Lab 5: Deploy the Arcadia Financial Services demo application, using manifests

<br/>

## Introduction

In this section, you will build the "Arcadia Finance" Demo, which represents a modern microservices based Banking application with 4 different services. You will be adding the following components to your Kubernetes Cluster: **Main** **Backend** **Files** and **API** `services`, `arcadia-secret`, and `Arcadia ` `virtualserver`.

<br/>

## Learning Objectives
- Deploy the Arcadia Financial Services Demo app
- Inspect the microservices and the matching VirtualServer manifests
- Verify the URL path access to all Services work correctly 
- Monitor the NGINX Plus Dashboard
- Verify login to the application and website is functioning correctly
